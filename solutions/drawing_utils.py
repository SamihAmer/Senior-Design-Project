...
def draw_landmarks(
  ...
  eye_key_indicies =  frozenset([(263, 249), (249, 390), (390, 373), (373, 374),
                               (374, 380), (380, 381), (381, 382), (382, 362),
                               (263, 466), (466, 388), (388, 387), (387, 386),
                               (386, 385), (385, 384), (384, 398), (398, 362), (33, 7), (7, 163), (163, 144), (144, 145),
                                (145, 153), (153, 154), (154, 155), (155, 133),
                                (33, 246), (246, 161), (161, 160), (160, 159),
                                (159, 158), (158, 157), (157, 173), (173, 133)])

  iris_key_indicies = frozenset([(474, 475), (475, 476), (476, 477),
                                 (477, 474),(469, 470), (470, 471), (471, 472),
                                 (472, 469)])
  ...
  for idx, landmark in enumerate(landmark_list.landmark):
    ...
    for landmark_px in idx_to_eye_coordinates.values():
        cv2.circle(image, landmark_px, 2, 1)
    for landmark_px in idx_to_iris_coordinates.values():
        cv2.circle(image, landmark_px,2)


    if landmark_px:
      idx_to_coordinates[idx] = landmark_px   #draws everything
  if connections:
